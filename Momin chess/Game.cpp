...
Game::Game(sf::Color c1, sf::Color c2)
{
    ...
    chance.setPosition(turn.getPosition().x, turn.getPosition().y + 40.f);
    ...
    situation.setPosition(chance.getPosition().x, chance.getPosition().y + 40.f);
    w_king = new King(1);
...
void Game::Start(sf::Color c1, sf::Color c2)
{
    ...
    {
        b_pawn[i]->y = i;
        b_pawn[i]->piece.setPosition(b_pawn[i]->y * 80.f + 40.f, b_pawn[i]->x * 80.f + 40.f);
        ...
        w_pawn[i]->y = i;
        w_pawn[i]->piece.setPosition(w_pawn[i]->y * 80.f + 40.f, w_pawn[i]->x * 80.f + 40.f);
    ...
    for (int i = 0; i < 2; i++)
    {
        b_bishop[i]->piece.setPosition(80.0f * b_bishop[i]->y + 40.f, 80.0f * b_bishop[i]->x + 40.f);
        b_knight[i]->piece.setPosition(80.0f * b_knight[i]->y + 40.f, 80.0f * b_knight[i]->x + 40.f);
        b_rook[i]->piece.setPosition(80.0f * b_rook[i]->y + 40.f, 80.0f * b_rook[i]->x + 40.f);
        b_bishop[i]->piece.setOrigin(80.0f * b_bishop[i]->x, 80.0f * b_bishop[i]->y);
        b_knight[i]->piece.setOrigin(80.0f * b_knight[i]->x, 80.0f * b_knight[i]->y);
        b_rook[i]->piece.setOrigin(80.0f * b_rook[i]->x, 80.0f * b_rook[i]->y);
        ...
        w_bishop[i]->piece.setPosition(80.0f * w_bishop[i]->y + 40.f, 80.0f * w_bishop[i]->x + 40.f);
        w_knight[i]->piece.setPosition(80.0f * w_knight[i]->y + 40.f, 80.0f * w_knight[i]->x + 40.f);
        w_rook[i]->piece.setPosition(80.0f * w_rook[i]->y + 40.f, 80.0f * w_rook[i]->x + 40.f);
        w_bishop[i]->piece.setOrigin(80.0f * w_bishop[i]->x, 80.0f * w_bishop[i]->y);
        w_knight[i]->piece.setOrigin(80.0f * w_knight[i]->x, 80.0f * w_knight[i]->y);
        w_rook[i]->piece.setOrigin(80.0f * w_rook[i]->x, 80.0f * w_rook[i]->y);
    ...
    for (int i = 0; i < 8; i++)
    {
        for (int j = 0; j < 8; j++)
        {
            cells[i][j].square.setPosition(sf::Vector2f(j * 80.0f, i * 80.0f));
            cells[i][j].square.setSize(sf::Vector2f(80.f, 80.f));
...
void Game::DrawPossibleMoves()
{
    ...
    for (int i = 0; i < moves.size(); i++)
    {
        ...
        tmp.setPosition(sf::Vector2f((moves[i].y) * 80.f, (moves[i].x) * 80.f));
        tmp.setSize(sf::Vector2f(80.f, 80.f));
        tmp.setFillColor(sf::Color(0x66b4cc50));
        newmoves.push_back(tmp);
    }
    sf::RectangleShape tmp;
    tmp.setPosition(sf::Vector2f((selected_piece->y) * 80.f, (selected_piece->x) * 80.f));
    tmp.setSize(sf::Vector2f(80.f, 80.f));
...
void Game::moveSelected(Square Cells[][8], int x, int y)
{
    ...
    if (valid)
    {
        selected_piece->piece.setPosition(sf::Vector2f(80.f * y + 40.f, 80.f * x + 40.f));
